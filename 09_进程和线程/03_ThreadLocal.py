...
'''
import threading
local_school = threading.local()#线程的局部变量
...
def process_thread(name):
    ...
    process_student()
t1 = threading.Thread(target=process_thread,args=('zzk',),name='Thread-A')
t2 = threading.Thread(target=process_thread,args=('bak',),name='Thread-B')
t1.start()
t2.start()
t1.join()
t2.join()
